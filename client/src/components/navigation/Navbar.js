...
import { Navbar, NavbarBrand, NavbarToggler, Collapse, Nav, NavItem, Button,  Modal, ModalHeader, ModalBody,  UncontrolledDropdown, DropdownToggle, DropdownMenu, DropdownItem,} from 'reactstrap'
...
let NavBar = (props) => {
    ...
    const profilePageOrLandingPage = (auth) => {
    ...
    return(
        <div>
            <Navbar dark sticky="top"  className=" navbar navbar-dark  navbar-expand-sm" expand="sm">
                ...
                {profilePageOrLandingPage(props.auth)}
            </Navbar>
        </div>
    )
}
